...
export default async function CertificateViewPage({
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* ---------------- HEADER ---------------- */}
      <section className="relative overflow-hidden section-muted border-b py-10 md:py-14 print:hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center">
            ...
            <h1 className="mx-auto max-w-2xl heading-display text-3xl sm:text-4xl md:text-4xl">
      ...
      <section className="container mx-auto flex flex-col items-center gap-8 px-4 py-12 md:py-16">
        <div
          ...
          className="w-full max-w-4xl overflow-hidden rounded-2xl border border-border bg-card p-2 shadow-2xl print:rounded-none print:border-none print:bg-transparent print:p-0 print:shadow-none"
        >
          <CertificateDocument
